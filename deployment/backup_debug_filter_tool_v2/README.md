...
本目录对应 `调试滤波工具v2`，仅作为备用版本保留。当前正式 deployment 使用 `../debug_filter_tool/`，对应 `调试滤波工具v1`。

v2 的核心差异是默认使用 `task_qat_w11_b13_noedge_shift10_delta_raw_dynamic.onnx`，并按 8-bit 4:2:0 YUV 透传 chroma 字节。
