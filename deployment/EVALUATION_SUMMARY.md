...
- `../training/runs/task_qat_noedge_test_summary.md`
- `../training/runs/task_qat_noedge_test_summary.json`
...
```text
input:
debug_filter_tool/data/kaideo_2560x1440_yuv420p_0.yuv

output:
debug_filter_tool/outputs/kaideo_2560x1440_yuv420p_0_w11_b13_shift10_rate1.yuv
```
