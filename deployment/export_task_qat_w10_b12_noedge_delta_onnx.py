#!/usr/bin/env python3
"""导出 task_qat_w10_b12_noedge best.pt 为 raw-Y residual ONNX。
...
CONFIG_PATH = (
    ...
    "task_qat_w10_b12_noedge/train_int_qat_config.yaml"
)
CHECKPOINT_PATH = (
    "/mnt/d/fudan/prefilter_clean/deliver_w10_b13/runs/"
    "task_qat_w10_b12_noedge/checkpoints/best.pt"
)
OUTPUT_ONNX_PATH = (
...
class ExportableQuantPrefilterYDeltaRawInput(nn.Module):
    ...
    当前推理脚本从 NV12 文件读出的 Y 已经是 uint8，再转 float32 后数值仍为
    整数 0..255，因此 ONNX 输入端不做任何 round/clip。
    """
