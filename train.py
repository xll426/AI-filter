...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train PrefilterNet with original AI-PreFilter-compatible settings.")
...
def build_train_loss(train_cfg: dict) -> tuple[CharbonnierLoss | None, MsssimLoss | None, EdgeConsistencyLoss | None]:
...
def validate(
    ...
    for batch in loader:
        ...
        preds = model(inputs)
        loss, _ = compute_train_loss(inputs, preds, targets, roi, only_train_y, fidelity_loss, perceptual_loss, edge_aux_loss)
