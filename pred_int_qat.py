...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run integer-QAT Prefilter inference.")
    parser.add_argument("--config", default="", help="Optional QAT config. Checkpoint config is used if omitted.")
    parser.add_argument("--checkpoint", required=True, help="QAT checkpoint from train_int_qat.py.")
